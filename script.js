...
function randomDate(inFuture = false) {
    const date = new Date();
    const year = inFuture ? randomIntFromInterval(2022, 2023) : randomIntFromInterval(2019, 2020);
    ...
    for (let i = 0; i < 5; i++) {
        ...
        await prisma.appointment.create({
            data: {
                ...
                practitionerId : practitioners[randomIntFromInterval(0, practitioners.length - 1)].id,
                startDate: startDate, 
